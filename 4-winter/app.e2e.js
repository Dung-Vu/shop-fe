/**
 * AURA Winter Dashboard - E2E Automated Tests (11 Tests)
 * Co-located inside 4-winter/
 */
...
module.exports = function(suite) {
  ...
  suite.test("Tier 1: R1 Configurator happy path updates KPI cards", 1, async (window, document, assert) => {
    ...
    document.getElementById("tx-id").value = "TX-9902";
    document.getElementById("tx-desc").value = "Winter Cloud Billing";
