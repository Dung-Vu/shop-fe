/**
 * AURA Warm Timber Dashboard - E2E Automated Tests (11 Tests)
 * Co-located inside 2-warm-timber/
 */
...
module.exports = function(suite) {
  ...
  suite.test("Tier 1: R1 Configurator happy path updates KPI cards", 1, async (window, document, assert) => {
    ...
    document.getElementById("tx-id").value = "TX-9900";
    document.getElementById("tx-desc").value = "Timber Cloud Billing";
